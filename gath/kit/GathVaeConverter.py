...
class GathVaeConverter:
    def __init__(self):
        pass

    def custom_convert_ldm_vae_checkpoint(self, checkpoint, config):
        ...
        down_blocks = {
            layer_id: [key for key in vae_state_dict if f"down.{layer_id}" in key] for layer_id in
        ...
        for i in range(num_down_blocks):
            ...
            assign_to_checkpoint(paths, new_checkpoint, vae_state_dict, additional_replacements=[meta_path],
                                 config=config)
    ...
    def vae_pt_to_vae_diffuser(
        ...
        converted_vae_checkpoint = self.custom_convert_ldm_vae_checkpoint(checkpoint["state_dict"], vae_config)
